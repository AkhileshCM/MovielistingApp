...
function Trailer(props) {
    ...
    return (
        <div className='heading'>
          ...
          {
            video=="noerror"?<div><video width="70%" height="50%" controls>
            <source src={link} type="video/mp4"/> 
            
          </video>
            <h2 style={{marginLeft:"15%"}}>Cant able to play<span style={{color:"blue"}}> <a href={link}   style={{color:"blue"}} id="tlink">Click here</a></span></h2></div>:<div style={{
              marginLeft:"20%",
              marginTop:"100px"
            }}>
